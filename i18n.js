...
(function () {
  ...
  var translations = {
    es: {
      ...
      'hero_subtitle': 'El escáner de productos más inteligente para vendedores de Amazon. Escanea códigos de barras, toma fotos de productos o explora ofertas seleccionadas — BuySignal te da análisis de ganancias instantáneo, insights con IA y datos de mercado en tiempo real en una sola app.',
      'hero_subtitle_bold': 'Datos de mercado de Keepa incluidos. Sin suscripciones extra.',
      ...
      'problem_subtitle': 'La mayoría de herramientas de escaneo fueron creadas hace años con interfaces sobrecargadas. Mereces algo mejor.',
      ...
      'features_subtitle': 'Creado desde cero por vendedores de Amazon que estaban cansados de las mismas herramientas rotas que todos usan.',
      ...
      'feat_more_spanish': 'Soporte completo en español',
      'feat_more_fbm': 'Cálculos de ganancia FBA y FBM',
      'feat_more_eligibility': 'Verificación de elegibilidad de marca',
      ...
      'comp_spanish': 'Soporte en español',
      'comp_fbm': 'Análisis de ganancias FBA + FBM',
      'comp_eligibility': 'Verificación de elegibilidad',
      ...
      'pricing_free_deals': '10 ofertas seleccionadas diarias',
      'pricing_free_ai': 'Análisis de mercado IA',
      'pricing_10saved': '10 productos guardados',
      'pricing_free_eligibility': 'Verificación de elegibilidad',
      'pricing_75scans': '75 escaneos por día',
      'pricing_scout_deals': '20 ofertas + casi-éxitos',
      'pricing_scout_ai': 'Consejos personalizados IA comprar/pasar',
      'pricing_unlimited_saved': 'Productos guardados ilimitados',
      'pricing_scout_charts': 'Analíticas multi-gráfica',
      ...
      'pricing_pro_deals': '30 ofertas seleccionadas diarias',
      'pricing_pro_sourcing': 'Sourcing mayoreo IA ✨',
      ...
      // Footer
      'footer_tagline': 'El escáner de productos más inteligente para vendedores de Amazon. Análisis con IA, datos de mercado en tiempo real y ofertas seleccionadas — todo en una app.',
